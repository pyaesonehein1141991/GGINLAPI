...
public class OperationClaimDTO extends MedicalClaimDTO {
	...
	public OperationClaimDTO(OperationClaimDTO operationClaimDTO) {
		...
		this.abortionAmt = operationClaimDTO.getAbortionAmt();
		...
		this.operationType = operationClaimDTO.getOperationType();
	...
	public double getAbortionAmt() {
		return abortionAmt;
	}

	public void setAbortionAmt(double abortionAmt) {
		this.abortionAmt = abortionAmt;
	}
