...
public class MedicalClaimBeneficiaryDTO extends CommonDTO {
	...
	private MedicalPolicyInsuredPersonDTO medicalPolicyInsuredPersonDTO;
	private Customer customer;
	private MedicalPolicyInsuredPersonBeneficiaryDTO medPolicyInsuBeneDTO;
	...
	public String getName() {
		if (beneficiaryRole.equals(MedicalBeneficiaryRole.INSURED_PERSON)) {
			name = medicalPolicyInsuredPersonDTO.getFullName();
		} else if (beneficiaryRole.equals(MedicalBeneficiaryRole.BENEFICIARY)) {
			name = medPolicyInsuBeneDTO.getName().getFullName();
		} else if (beneficiaryRole.equals(MedicalBeneficiaryRole.GUARDIAN)) {
			name = medPolicyGuardianDTO.getCustomerDTO().getName().getFullName();
		}
		return name;
	}
	...
	public String getNrc() {
		if (beneficiaryRole.equals(MedicalBeneficiaryRole.INSURED_PERSON)) {
			nrc = medicalPolicyInsuredPersonDTO.getIdNo();
		} else if (beneficiaryRole.equals(MedicalBeneficiaryRole.BENEFICIARY)) {
			nrc = medPolicyInsuBeneDTO.getIdNo();
		} else if (beneficiaryRole.equals(MedicalBeneficiaryRole.GUARDIAN)) {
			nrc = medPolicyGuardianDTO.getCustomerDTO().getIdNo();
		}
		return nrc;
	}
	...
	public ResidentAddress getResidentAddress() {
		if (beneficiaryRole.equals(MedicalBeneficiaryRole.INSURED_PERSON)) {
			...
			residentAddress = medPolicyInsuBeneDTO.getResidentAddress();
		} else if (beneficiaryRole.equals(MedicalBeneficiaryRole.GUARDIAN)) {
			residentAddress = medPolicyGuardianDTO.getCustomerDTO().getResidentAddress();
		}
	...
	public void setMedicalPolicyInsuredPersonDTO(MedicalPolicyInsuredPersonDTO medicalPolicyInsuredPersonDTO) {
		this.medicalPolicyInsuredPersonDTO = medicalPolicyInsuredPersonDTO;
	}
	...
	public void setMedPolicyInsuBeneDTO(MedicalPolicyInsuredPersonBeneficiaryDTO medPolicyInsuBeneDTO) {
		this.medPolicyInsuBeneDTO = medPolicyInsuBeneDTO;
	}
	...
	public void setMedPolicyGuardianDTO(PolicyGuardianDTO medPolicyGuardianDTO) {
		this.medPolicyGuardianDTO = medPolicyGuardianDTO;
	}
	...
	public String getRelationShipName() {
		if (beneficiaryRole.equals(MedicalBeneficiaryRole.INSURED_PERSON)) {
			...
			if (medPolicyInsuBeneDTO.getRelationship() == null) {
				relationShipName = "";
			} else {
				relationShipName = medPolicyInsuBeneDTO.getRelationship().getName();
			}
		} else if (beneficiaryRole.equals(MedicalBeneficiaryRole.GUARDIAN)) {
			if (medPolicyGuardianDTO.getRelationship() == null) {
				relationShipName = "";
			} else {
				relationShipName = medPolicyGuardianDTO.getRelationship().getName();
			}
		} else {
			relationShipName = this.getRelationShip().getName();
		}
	...
	public int hashCode() {
		...
		result = prime * result + ((medPolicyGuardianDTO == null) ? 0 : medPolicyGuardianDTO.hashCode());
		result = prime * result + ((medPolicyInsuBeneDTO == null) ? 0 : medPolicyInsuBeneDTO.hashCode());
		temp = Double.doubleToLongBits(mediClaimAmount);
		result = prime * result + (int) (temp ^ (temp >>> 32));
		result = prime * result + ((medicalClaimProposalDTO == null) ? 0 : medicalClaimProposalDTO.hashCode());
		result = prime * result + ((medicalPolicyInsuredPersonDTO == null) ? 0 : medicalPolicyInsuredPersonDTO.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MedicalClaimBeneficiaryDTO other = (MedicalClaimBeneficiaryDTO) obj;
		...
		if (id == null) {
			...
			return false;
		if (medPolicyGuardianDTO == null) {
			if (other.medPolicyGuardianDTO != null)
				return false;
		} else if (!medPolicyGuardianDTO.equals(other.medPolicyGuardianDTO))
			return false;
		if (medPolicyInsuBeneDTO == null) {
			if (other.medPolicyInsuBeneDTO != null)
				return false;
		} else if (!medPolicyInsuBeneDTO.equals(other.medPolicyInsuBeneDTO))
			return false;
		if (Double.doubleToLongBits(mediClaimAmount) != Double.doubleToLongBits(other.mediClaimAmount))
			return false;
		if (medicalClaimProposalDTO == null) {
			if (other.medicalClaimProposalDTO != null)
				return false;
		} else if (!medicalClaimProposalDTO.equals(other.medicalClaimProposalDTO))
			return false;
		if (medicalPolicyInsuredPersonDTO == null) {
			if (other.medicalPolicyInsuredPersonDTO != null)
				return false;
		} else if (!medicalPolicyInsuredPersonDTO.equals(other.medicalPolicyInsuredPersonDTO))
			return false;
		if (name == null) {
			if (other.name != null)
				return false;
