...
public class DeathClaimDTO implements Serializable {
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((claimInsuredPersonInfoDTO == null) ? 0
						: claimInsuredPersonInfoDTO.hashCode());
		result = prime * result
				+ ((customerName == null) ? 0 : customerName.hashCode());
		result = prime * result
				+ ((lifePolicy == null) ? 0 : lifePolicy.hashCode());
		result = prime * result
		...
		result = prime * result
				+ ((successorId == null) ? 0 : successorId.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (claimInsuredPersonInfoDTO == null) {
			if (other.claimInsuredPersonInfoDTO != null)
				return false;
		} else if (!claimInsuredPersonInfoDTO
				.equals(other.claimInsuredPersonInfoDTO))
			return false;
