...
@NamedQueries(value = {
		@NamedQuery(name = "ClaimBeneficiary.findAll", query = "SELECT c FROM LifeClaimBeneficiary c "),
...
public abstract class LifeClaimBeneficiary implements Serializable, IEntity{
	...
	public LifeClaimBeneficiary( Date paymentDate, double claimAmount,
			double loanAmount, double loanInterest, double renewelAmount, double renewInterest, double netClaimAmount,
			Payment payment) {
