...
public class LifeClaimInsuredPersonBeneficiary extends LifeClaimBeneficiary
		implements IEntity {
	...
	public void setPolicyInsuredPersonBeneficiaries(
			PolicyInsuredPersonBeneficiaries policyInsuredPersonBeneficiaries) {
	...
	public void setClaimInsuredPersonBeneficiaryAttachmentList(
			List<LifeClaimInsuredPersonBeneficiaryAttachment> claimInsuredPersonBeneficiaryAttachmentList) {
	...
	public void update(
		...
		this.claimInsuredPerson = claimInsuredPersonBeneficiary
				.getClaimInsuredPerson();
		this.policyInsuredPersonBeneficiaries = claimInsuredPersonBeneficiary
				.getPolicyInsuredPersonBeneficiaries();
		this.claimInsuredPersonBeneficiaryAttachmentList = claimInsuredPersonBeneficiary
				.getClaimInsuredPersonBeneficiaryAttachmentList();
	...
	public String getFullResidentAddress() {
		return this.policyInsuredPersonBeneficiaries.getResidentAddress()
				.getFullResidentAddress();
	}
	...
	public boolean isClaimInsuredPersonBeneficiary() {
		return LifeClaimBeneficiaryRole.INSUREDPERSONBENEFICIARY
				.equals(getBeneficiaryRole());
	}

	public boolean isClaimInsuredPerson() {
		return LifeClaimBeneficiaryRole.INSUREDPERSON
				.equals(getBeneficiaryRole());
	}
	...
	public boolean isDeathPerson() {
		return LifeClaimBeneficiaryRole.DEATHPERSON
				.equals(getBeneficiaryRole());
	}

	public boolean isDisabilityPerson() {
		return LifeClaimBeneficiaryRole.DISABILITYPERSON
				.equals(getBeneficiaryRole());
	}
