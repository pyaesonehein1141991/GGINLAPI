...
import org.tat.gginl.api.common.Operation;
import org.tat.gginl.api.common.OperationType;
...
public class OperationClaim extends MedicalClaim implements Serializable {
	...
	public double getAbortionAmount() {
		return abortionAmount;
	}

	public void setAbortionAmount(double abortionAmount) {
		this.abortionAmount = abortionAmount;
	}
